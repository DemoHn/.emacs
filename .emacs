...
;;<x-color><param>Firebrick</param><<x-color><<param>#99968b<</param>设置字体
</x-color><</x-color>(set-default-font <<x-color><<param>#95e454<</param><x-color><param>VioletRed4</param>"Microsoft YaHei-10"</x-color><</x-color>)
(set-default-font <<x-color><<param>#95e454<</param><x-color><param>VioletRed4</param>"Consolas-10"</x-color><</x-color>)
...
(display-time-mode 1) ;<x-color><param>Firebrick</param><<x-color><<param>#99968b<</param>显示时间
</x-color><</x-color>(setq display-time-24hr-format t) ;<<x-color><<param>#99968b<</param>24小时格式
...
(define-key ac-mode-map (kbd <<x-color><<param>#95e454<</param><x-color><param>VioletRed4</param>"\M-\t"</x-color><</x-color>) 'auto-complete)


;; <x-color><param>Firebrick</param><<x-color><<param>#99968b<</param>move emacs backup file into /tmp
</x-color>
<</x-color>(setq backup-directory-alist
      `((<<x-color><<param>#95e454<</param><x-color><param>VioletRed4</param>".*"</x-color><</x-color> . ,temporary-file-directory)))
(setq auto-save-file-name-transforms
      `((<<x-color><<param>#95e454<</param><x-color><param>VioletRed4</param>".*"</x-color><</x-color> ,temporary-file-directory t)))
